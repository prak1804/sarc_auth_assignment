...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-auth-service-secret-key-change-in-prod')
...
AUTH_USER_MODEL = 'auth_app.CentralUser'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': config('AUTH_DB_PASSWORD', default='postgres'),
